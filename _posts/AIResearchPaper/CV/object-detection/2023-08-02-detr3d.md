...
<span style="color:yellow"> $$ \textbf{f}_{li}={1 \over \Sigma_k \Sigma_m \sigma_{lkmi} +\epsilon} \Sigma_k \Sigma_m  \textbf{f}_{lkmi} \sigma_{lkmi}$$ </spab>
...
## Weakness
- ~~<Depth style="color:orange"> **Depth 정보 미사용** </span>: DETR-3D는 depth estimation을 고려하지 않으며, 물체의 실제 깊이 정보를 활용하지 않습니다. 따라서 일부 물체에 대해서는 정확한 깊이 정보를 추정하는데 어려움이 있을 수 있습니다.~~
