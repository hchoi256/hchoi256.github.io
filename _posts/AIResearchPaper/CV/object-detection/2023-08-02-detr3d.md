...
상기 코드에서 `F.grid_sample` 함수는 pytorch 문서에 다음과 같이 정의되어 있습니다:

torch.nn.functional.grid_sample(input, grid, mode='<span style="color:lightblue">bilinear</span>', padding_mode='zeros', align_corners=None)
