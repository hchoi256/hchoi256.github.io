...
상기 모형에 자세한 설명이 나와있으니, 추가적인 설명은 생략한다.
...
다음 시간에는 GAN의 Image-to-Image Translation 기법을 활용한 GAN의 확장버전인 [CycleGAN](https://hchoi256.github.io/aipapercv/CycleGAN/)에 대해 알아보자.